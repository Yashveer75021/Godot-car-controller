...
const TIRE_WEAR_CURVE = preload("res://script/Vehicle/TireModel/tire_wear_curve.tres")
const TIRE_TEMP_MU = preload("res://script/Vehicle/TireModel/temp_mu.tres")
...
func _init() -> void:
	var _point_pos := TIRE_TEMP_MU.get_point_position(1)
